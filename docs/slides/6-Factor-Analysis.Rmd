...
.pull-left[
```{r class-dim, echo = FALSE, fig.show = "hide", fig.height=6}
ggplot(class_dims, 
       aes(x = x, y = y)) +
  geom_point(size = 3) +
...
.pull-right[
```{r both-facs, echo = FALSE, fig.height=6}
ggplot(class_dims, 
       aes(x = x, y = y)) +
  geom_point(size = 5) +
  lims(x = c(-1, 1), y = c(-1, 1)) + 
...
.pull-right[
```{r fac-load-emo, echo = FALSE, fig.height=6}
ggplot(class_dims, 
       aes(x = x, y = y)) +
  geom_point(size = 5) +
  lims(x = c(-1, 1), y = c(-1, 1)) + 
...
.pull-right[
```{r fac-dim-hum, echo = FALSE, fig.height=6}
ggplot(class_dims, 
       aes(x = x, y = y)) +
  geom_point(size = 5) +
  lims(x = c(-1, 1), y = c(-1, 1)) + 
...
```{r scree-plot1, fig.show = "hide", fig.height=6}
...
.pull_right[
```{r screeplotmark, echo = FALSE, fig.height=6}
scree(hexaco_only, factors = FALSE)
...
```{r parallel-fa, fig.show = "hide", fig.height=6}
